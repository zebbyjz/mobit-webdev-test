...
function AddUser() {
    const defaultSchema= {"Name":"","Email":"","Mobile Number":"","Age":"",errors:{"Email":0,"Age":0}};
    ...
    const onSubmitUser=(event)=>{
      ...
      const renderError=(name)=>{
        ...
        if(name==="Email" && fields['errors']["Email"]===1){return <p style={{color:"red"}}>Invalid Email Address.</p>}
        if(name==="Age" && fields['errors']["Age"]===1){return <p style={{color:"red"}}>Invalid Age. Must be between 18-60 years</p>}
      }
            ...
            <div className="d-flex flex-row">
                ...
                <div className="container mt-5 ms-5" style={{width:"30%"}}>
                    ...
                    <form onSubmit={(event)=>onSubmitUser(event)}>
                        ...
                        <button className='btn btn-success mt-5' type="submit" disabled={(fields.errors.Age===0 && fields.errors.Email===0)?false:true}>Submit</button>
                    </form>
                </div>
            </div>
        </React.Fragment>
